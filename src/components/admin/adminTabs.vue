<template>
  <div
    class="w-full h-12 border-b border-l border-solid gvb-tabs border-b-gray-500/20 border-l-gray-500/20"
  >
    <div class="flex items-center justify-between tabs-container">
      ...
      <el-button @click="removeAllTabs" link class="mb-2 mr-2" :icon="Delete">全部删除 </el-button>
    </div>
  </div>
</template>
